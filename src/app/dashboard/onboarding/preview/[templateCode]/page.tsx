...
export default async function TemplatePreviewPage({
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed top-0 left-0 right-0 z-[100] flex flex-wrap items-center justify-between gap-2 border-b border-white/10 bg-neutral-950/95 px-3 py-3 backdrop-blur-md sm:gap-4 sm:px-4">
