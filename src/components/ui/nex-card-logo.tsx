...
export function NexCardLogo({
  ...
  return (
    <div className={`inline-flex items-center gap-2 ${className}`}>
      ...
      {showText && (
        <span
          className="font-black tracking-widest leading-none bg-clip-text text-transparent"
          style={{
            fontSize: size * 0.45,
            backgroundImage: `linear-gradient(135deg, ${c1}, ${c3})`,
          }}
        >
          NEX CARD
        </span>
...
// Keep your Static component definition here untouched as well...
// Static fallback wrapper used inside the Provider boundary safely
export function NexCardLogoStatic({
  ...
  return (
    <div className={`inline-flex items-center gap-2 ${className}`}>
      ...
      {showText && (
       <span
  className="font-black tracking-widest bg-[linear-gradient(135deg,var(--c1),var(--c3))] bg-clip-text text-transparent"
  style={{
    fontSize: size * 0.45,
    "--c1": c1,
    "--c3": c3,
